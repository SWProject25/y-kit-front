    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: COLORS.gray50 }}>
      ...
      <main className="flex-1 w-full pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* 헤더 카드 - Full Width */}
          <Card className="rounded-xl mb-6" style={{ borderColor: COLORS.skyBorder }}>
            <CardHeader className="pb-6">
              ...
              {/* 정책명 */}
              <CardTitle className="text-3xl md:text-4xl mb-4 leading-tight" style={{ color: COLORS.navy }}>
              ...
              <div className="flex gap-3 pt-6">
                ...
                >
                  <Bookmark size={18} className={isBookmarked ? 'fill-yellow-400 text-yellow-400' : ''} />
                </Button>
                <Button 
                  variant="outline"
                  size="lg"
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <Card className="rounded-xl shadow-sm">
                  ...
                  <CardContent className="space-y-4 pt-6">
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">{policy.aiAnalysis.summary}</p>
                    </div>
                    <Separator />
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">{policy.aiAnalysis.pros}</p>
                    </div>
                    <Separator />
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">{policy.aiAnalysis.corn}</p>
                    </div>
                  </CardContent>
                </Card>
              )}
              ...
              <Card className="rounded-xl shadow-sm">
                ...
                <CardContent className="space-y-6 pt-6">
                  {/* 정책 설명 */}
                  <div>
                    <h3 className="font-semibold text-base mb-3" style={{ color: COLORS.navy }}>정책 설명</h3>
                  ...
                  {/* 지원 내용 */}
                  <div>
                    <h3 className="font-semibold text-base mb-3" style={{ color: COLORS.navy }}>지원 내용</h3>
                  ...
                  {/* 기관 & 사업 정보 */}
                  <div>
                    <h3 className="font-semibold text-base mb-4" style={{ color: COLORS.navy }}>기관 및 사업 정보</h3>
                  ...
                  {(policy.detail.referenceUrl1 || policy.detail.referenceUrl2) && (
                    <>
                      <Separator />
                      <div>
                        <h3 className="font-semibold text-base mb-3" style={{ color: COLORS.navy }}>참고 링크</h3>
            ...
            <div className="space-y-6">
              ...
              <Card className="rounded-xl shadow-sm">
                ...
                <CardContent className="pt-6">
                  {/* 자격 요건 */}
                  <div className="mb-6">
                    <h3 className="font-semibold text-sm mb-3" style={{ color: COLORS.navy }}>자격 요건</h3>
                    {policy.qualification.ageLimitYn === 'Y' && (
                      <div className="mb-3">
                        <h4 className="text-xs font-medium text-gray-500 mb-1">연령</h4>
                        <p className="text-sm text-gray-900">만 {policy.qualification.minAge}~{policy.qualification.maxAge}세</p>
                      </div>
                    )}
                    {policy.qualification.employmentStatus && (
                      <div className="mb-3">
                        <h4 className="text-xs font-medium text-gray-500 mb-1">취업 상태</h4>
                        <p className="text-sm text-gray-900">{policy.qualification.employmentStatus}</p>
                      </div>
                    )}
                    {policy.qualification.educationLevel && (
                      <div className="mb-3">
                        <h4 className="text-xs font-medium text-gray-500 mb-1">학력</h4>
                        <p className="text-sm text-gray-900">{policy.qualification.educationLevel}</p>
                      </div>
                    )}
                    {policy.qualification.additionalQualification && (
                      <div className="pt-3 border-t">
                        <h4 className="text-xs font-medium text-gray-500 mb-1">추가 자격 조건</h4>
                  ...
                  {/* 신청 정보 */}
                  <div className="mt-6">
                    <h3 className="font-semibold text-sm mb-3" style={{ color: COLORS.navy }}>신청 정보</h3>
                    <div className="mb-3">
                      <h4 className="text-xs font-medium text-gray-500 mb-1">신청 기간</h4>
                    ...
                    <div className="mb-3">
                      <h4 className="text-xs font-medium text-gray-500 mb-1">신청 방법</h4>
                      <p className="text-sm text-gray-900">{policy.application.applicationMethod || '-'}</p>
                    </div>
                    {policy.detail.screeningMethod && (
                      <div className="pt-3 border-t">
                        <h4 className="text-xs font-medium text-gray-500 mb-1">심사 방법</h4>
                        <p className="text-sm text-gray-700 leading-relaxed whitespace-pre-line">
                          {policy.detail.screeningMethod}
                        </p>
                      </div>
